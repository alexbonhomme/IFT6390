...
Afin de vérifier le bon fonctionnement des algorithme implémenté nous avons mis en oeuvre quelques procédure du vérification.
...
\begin{figure}[H]
        ...
        \begin{subfigure}[b]{110pt}
                \centering
                \includegraphics[width=110pt]{images_rapport/nnet_risque.png}
                \caption{Risque empirique}
        \end{subfigure}
        \begin{subfigure}[b]{110pt}
                \centering
                \includegraphics[width=110pt]{images_rapport/nnet_erreur_classif.png}
                \caption{Erreur de classification}
        \end{subfigure}
        \begin{subfigure}[b]{110pt}
                \centering
                \includegraphics[width=110pt]{images_rapport/nnet_fontieres.png}
